...
<head>
    ...
    <link rel="icon" type="" href="images/husky.jpg"/>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="#section_2">Acerca de nosotros</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="#section_4">Voluntarios</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="#section_6">Contactenos</a>
                    </li>

                    <li class="nav-item ms-3">
                        <a class="nav-link custom-btn custom-border-btn btn" href="./vista/login.php">Ingrese</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="col-lg-12 col-12 p-0">
                        <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img src="images/animalitos/ima_8.jpg"
                                        class="carousel-image img-fluid" alt="...">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <form class="custom-form volunteer-form mb-5 mb-lg-0" action="#" method="post" role="form">
                            ...
                            <button type="submit" class="form-control" href="../Proyecto Empresa/vistas/dashboard.php">Submit</button>
                        </form>
                    </div>
